package com.qingshangzuo.metalslug.game;
...
public class Graphics {
    ...
    // 定义绘制弧的方法
    public static void drawArc(Canvas canvas, float x, float y, float width, float height, float startAngle, float sweepAngle, Paint paint){
        paint.setStyle(Paint.Style.STROKE);
     ...
     */
    public static void drawBorderString(Canvas c,int borderColor,int textColor,String text,int x,int y,int borderWidth,Paint mPaint){
