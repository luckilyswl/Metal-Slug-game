...
import com.qingshangzuo.metalslug.GameView;
import com.qingshangzuo.metalslug.ViewManager;
import com.qingshangzuo.metalslug.game.Graphics;
...
// -------下面代码根据怪物类型来初始化怪物X、Y坐标------
        ...
        if (type == TYPE_BOMB || type == TYPE_MAN) {
            y = Player.Y_DEFALUT;
        } else if (type == TYPE_FLY) {   // 如果怪物是飞机，根据屏幕高度随机生成怪物的Y坐标
